...
<style>
    .styled-table {
        ...
        font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; min-width: 400px;
    ...
    .styled-table tbody tr:last-of-type { border-bottom: 4px solid #343a40; }
        ...
        with st.container(border=True):
            if grade_labels:
               ...
               # --- NOVA TABELA: Apenas Células com Sequência ---
                            ...
                            st.markdown(CSS_ESTILO_TABELA, unsafe_allow_html=True)
                            st.write(df_seq_estilizado.to_html(classes='styled-table', escape=False), unsafe_allow_html=True)  
